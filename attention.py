...
model1 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_DenseNet121_100epochs_G05_1024patchsize.h5', compile=False)
model2 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_DenseNet169_100epochs_G05_1024patchsize.h5', compile=False)
model3 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_DenseNet201_100epochs_G05_1024patchsize.h5', compile=False)
model4 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_ResNet50_100epochs_G05_1024patchsize.h5', compile=False)
model5 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_ResNet50V2_100epochs_G05_1024patchsize.h5', compile=False)
model6 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_ResNet101_100epochs_G05_1024patchsize.h5', compile=False)
model7 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_ResNet101V2_100epochs_G05_1024patchsize.h5', compile=False)
model8 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_resnet152_100epochs_G05_1024patchsize.h5', compile=False)
model9 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_resnet152v2_100epochs_G05_1024patchsize.h5', compile=False)
model10 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_VGG16_100epochs_G05_1024patchsize.h5', compile=False)
model11 = load_model('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/unet_3plus_2d_VGG19_100epochs_G05_1024patchsize.h5', compile=False)
...
for test_img_number in range(len(X_test)):
    ...
    if test_img_number < 10:
        plt.savefig("D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/prediction of val images/" + "0" + str(test_img_number) + ".png")
    else:
        plt.savefig("D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/prediction of val images/" + str(test_img_number) + ".png")
...
for test_lbl in test_labels:
    ...
    plt.xticks([])  # remove x-axis values
    plt.yticks([])  # remove y-axis values
    plt.savefig("D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/prediction of test images/" + test_lbl + ".png")
...
iou_df.to_csv('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/iou_values_for_test_images.csv', index=False)
avg_iou_df.to_csv('D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/avg_iou_values_for_test_images.csv', index=False)
...
for test_lbl in test_labels:
    ...
    plt.xticks([])  # remove x-axis values
    plt.yticks([])  # remove y-axis values
    plt.savefig("D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/prediction of test images with IOU/" + test_lbl + ".png")
    plt.show()
    cnt += 1
...
for test_img_number in range(len(X_test)):
    ...
    plt.yticks([])  # remove y-axis values
    if test_img_number < 10:
        plt.savefig("D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/prediction of val images with IOU/" + "0" + str(test_img_number) + ".png")
    else:
        plt.savefig("D:/peyman/Mars/207/attention unet/1024 patch size/models/unet_3plus_2d/prediction of val images with IOU/" + str(test_img_number) + ".png")
